...
a| [[onecx-permission-svc_onecx-permission-default-roles]] [.property-path]##link:#onecx-permission-svc_onecx-permission-default-roles[`+++onecx.permission.default-roles+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++onecx.permission.default-roles+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++ONECX_PERMISSION_DEFAULT_ROLES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++ONECX_PERMISSION_DEFAULT_ROLES+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|
